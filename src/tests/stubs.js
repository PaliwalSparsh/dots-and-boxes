...
export const grid_2x2 = [
	[
		...
		{ row: 1, column: 0, left: 0, top: 0, completedBy: 0 },
		{ row: 2, column: 0, left: 0, top: null, completedBy: null },
	],
	[
		{ row: 0, column: 1, left: 0, top: 0, completedBy: 0 },
		{ row: 1, column: 1, left: 0, top: 0, completedBy: 0 },
		{ row: 2, column: 1, left: 0, top: null, completedBy: null },
	],
	[
		{ row: 0, column: 2, left: null, top: 0, completedBy: null },
		{ row: 1, column: 2, left: null, top: 0, completedBy: null },
	],
];
